...
app.get("/", function(req, res)
{
    ...
    res.sendFile(path.join(__dirname, "../tradercoin.io/home.html"));
...
//   response.sendFile(path.resolve(__dirname, '../react-ui/build', 'home.html'));
...
app.use(express.static(path.join(__dirname, '../Tradercoin.io/public')));
