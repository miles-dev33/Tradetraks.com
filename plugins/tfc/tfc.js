...
CIQ.TFC.prototype.enableBracket=function(params){
	...
	if(position.quantity>0){
		...
		CIQ.swapClassName(this.dom.dragLineBelow, "red", "green");
		CIQ.appendClassName(this.dom.limitOrder, "new-sell-order");
		this.elements.otoAboveLegLabel.appendChild(CIQ.translatableTextNode(this.stx,"Take Profit"));
		this.elements.otoBelowLegLabel.appendChild(CIQ.translatableTextNode(this.stx,"Stop Loss"));
	}else{
		this.activeTrade="bracket_cover";
		CIQ.swapClassName(this.dom.dragLineAbove, "green", "red");
		CIQ.swapClassName(this.dom.dragLineBelow, "green", "red");
		CIQ.appendClassName(this.dom.limitOrder, "new-cover-order");
		this.elements.otoBelowLegLabel.appendChild(CIQ.translatableTextNode(this.stx,"Take Profit"));
		this.elements.otoAboveLegLabel.appendChild(CIQ.translatableTextNode(this.stx,"Stop Loss"));
	}
...
CIQ.TFC.prototype.updateValues=function(){
	...
	if(this.activeTrade=="market"){
		...
		if(amount || amount===0) CIQ.setValueIfNotActive(this.elements.limitCurrency, CIQ.commas(amount.toFixed(2)));
		if(quantity || quantity===0) CIQ.setValueIfNotActive(this.elements.limitShares, CIQ.commas(quantity));
	}
...
CIQ.TFC.prototype.construct=function(config){
	...
	CIQ.safeClickTouch(this.elements.marketBuy, function(self, action) { return function(e){ self.userAction(action);};}(this, "market_buy"), {"safety":safety});
	CIQ.safeClickTouch(this.elements.marketSell, function(self, action) { return function(e){ self.userAction(action);};}(this, "market_sell"), {"safety":safety});

	CIQ.safeClickTouch(this.elements.limitBuy, function(self, action) { return function(e){ self.userAction(action);};}(this, "limit_buy"), {"safety":safety});
	CIQ.safeClickTouch(this.elements.limitSell, function(self, action) { return function(e){ self.userAction(action);};}(this, "limit_sell"), {"safety":safety});
	CIQ.safeClickTouch(this.elements.limitShort, function(self, action) { return function(e){ self.userAction(action);};}(this, "limit_short"), {"safety":safety});
	CIQ.safeClickTouch(this.elements.limitCover, function(self, action) { return function(e){ self.userAction(action);};}(this, "limit_cover"), {"safety":safety});
	CIQ.safeClickTouch(this.elements.limitReplace, function(self, action) { return function(e){ self.userAction(action);};}(this, "replace"), {"safety":safety});

	CIQ.safeClickTouch(this.elements.ocoTrade, function(self, action) { return function(e){ self.userAction(action);};}(this, "OCO"), {"safety":safety});
